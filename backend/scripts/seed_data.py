...
MUNICIPIOS_OBJETIVO = [
    ...
    ("88", "220", "BRASIL"),
    ("88", "250", "CANADA"),
    ("88", "275", "COREA DEL SUR"),
    ("88", "285", "COSTA RICA"),
    ("88", "290", "CUBA"),
    ("88", "305", "CHILE"),
    ("88", "315", "CHINA REPUBLICA POPULAR"),
    ("88", "325", "DINAMARCA"),
    ("88", "330", "ECUADOR"),
    ("88", "335", "EGIPTO"),
    ("88", "340", "EL SALVADOR"),
    ("88", "350", "EMIRATOS ARABES UNIDOS"),
    ("88", "355", "ESPAÑA"),
    ("88", "360", "ESTADOS UNIDOS"),
    ("88", "370", "REPUBLICA DE FILIPINAS"),
    ("88", "375", "FINLANDIA"),
    ("88", "380", "FRANCIA"),
    ("88", "410", "GUATEMALA"),
    ("88", "435", "PAISES BAJOS"),
    ...
    ("88", "680", "PORTUGAL"),
    ("88", "683", "PUERTO RICO"),
    ("88", "685", "REPUBLICA DOMINICANA"),
    ("88", "688", "REPUBLICA DE SINGAPUR"),
    ("88", "690", "REPUBLICA SOCIALISTA DEVIETNAM"),
    ("88", "700", "RUSIA"),
    ("88", "745", "SUDAFRICA"),
    ("88", "755", "SUECIA"),
    ("88", "760", "SUIZA"),
...
ZONAS_MUNICIPIO_EJEMPLO = [
    # Antioquia (dept 01), Medellín (muni 001)
    ("01", "001", "1", "ZONA 01"),
    ("01", "001", "2", "ZONA 02"),
    ("01", "001", "3", "ZONA 03"),
    ("01", "001", "4", "ZONA 04"),
    ...
    # Antioquia (dept 01), Abejorral (muni 004)
    ("01", "004", "0", "ZONA 00"),
    ("01", "004", "98", "ZONA 98"),
    ("01", "004", "99", "ZONA 99"),
